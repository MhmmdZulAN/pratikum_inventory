                   ...
                   <ul class="navbar-nav ms-auto">
                       ...
                       <li class="nav-item dropdown user-menu">
                           <a href="#" class="nav-link dropdown-toggle" data-bs-toggle="dropdown">
                               <img src="../assets/img/ZUL.jpeg" class="user-image rounded-circle shadow"
                                   alt="User Image" />
                               <span class="d-none d-md-inline">ZUL</span>
                           </a>
                           <ul class="dropdown-menu dropdown-menu-lg dropdown-menu-end">
                               <!--begin::User Image-->
                               <li class="user-header text-bg-primary">
                                   <img src="../assets/img/ZUL.jpeg" class="rounded-circle shadow"
                                       alt="User Image" />
                                   <p>
                                       ZUL - Admin
                                       <small>Member since June 2026</small>
                                   </p>
                               </li>
                               <!--end::User Image-->
                               <!--begin::Menu Body-->
